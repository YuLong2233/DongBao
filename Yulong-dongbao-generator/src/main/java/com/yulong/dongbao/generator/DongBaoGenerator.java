package com.yulong.dongbao.generator;
 ...
 * @Auther: YuLong
 * @Date: 2021/10/22
 * @Description: com.yulong.dongbao.generator
 */
public class DongBaoGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("F:\\Java资料\\YuLong-dongbao-mall-parent\\YuLong-dongbao-service\\YuLong-dongbao-ums\\src\\main\\java");
        gc.setAuthor("YuLong");
        ...
        dsc.setUrl("jdbc:mysql://192.168.31.120:3306/dongbao?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai");
